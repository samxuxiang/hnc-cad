...
class TransformerDecoderLayerImproved(Module):
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, activation="relu"):
        ...
        self.multihead_attn = MultiheadAttention(d_model, nhead, dropout=dropout, use_alibi=False)
...
class TransformerDecoderLayerImproved_v2(Module):
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, activation="relu"):
        super(TransformerDecoderLayerImproved_v2, self).__init__()
        self.self_attn = MultiheadAttention(d_model, nhead, dropout=dropout, use_alibi=False)
    ...
    def __setstate__(self, state):
        if 'activation' not in state:
            state['activation'] = F.relu
        super(TransformerDecoderLayerImproved_v2, self).__setstate__(state)
