...
## Demo
If you want to try CAD generation without training the model, you can download our pretrained weights from [here](xxx), then just run the sample and visualization script  ```sample_gen.sh```. This output 1000 randomly generated models.
